...
A documentação da integração com a API está no arquivo:

[DOCUMENTACAO_API.md](DOCUMENTACAO_API.md)

Nele são explicados o endpoint utilizado, a autenticação, o payload JSON, as rotas internas e o fluxo completo da comunicação.
